...
type ConsumeResponse struct {
	...
	Record uint64 `protobuf:"varint,2,opt,name=record,proto3" json:"record,omitempty"`
}
...
func (x *ConsumeResponse) GetRecord() uint64 {
	if x != nil {
		return x.Record
	}
	return 0
...
var file_api_v1_log_proto_rawDesc = []byte{
	...
	0x04, 0x52, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x22, 0x29, 0x0a, 0x0f, 0x43, 0x6f, 0x6e,
	0x73, 0x75, 0x6d, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06,
	0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x72, 0x65,
...
var file_api_v1_log_proto_depIdxs = []int32{
	...
	0, // 1: log.v1.Log.Produce:input_type -> log.v1.ProduceRequest
	2, // 2: log.v1.Log.Consume:input_type -> log.v1.ConsumeRequest
	2, // 3: log.v1.Log.ConsumeStream:input_type -> log.v1.ConsumeRequest
	...
	3, // 7: log.v1.Log.ConsumeStream:output_type -> log.v1.ConsumeResponse
